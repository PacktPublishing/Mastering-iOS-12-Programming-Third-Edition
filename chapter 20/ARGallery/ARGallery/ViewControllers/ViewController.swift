...
//  ARGallery
//
//  Created by Donny Wals on 09/08/2018.
...
class ViewController: UIViewController {
  ...
  var images: [UIImage] = [UIImage(named: "img_1")!, UIImage(named: "img_2")!, UIImage(named: "img_3")!, UIImage(named: "img_4")!, UIImage(named: "img_5")!]
  ...
  func addImageToGallery(_ image: UIImage) {
    ...
    imageNodes[anchor.identifier] = image
